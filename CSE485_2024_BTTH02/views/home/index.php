        ...
        ?>
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    <img src="assets/<?php echo $row->getHinhanh(); var_dump($row->getHinhanh()) ?>" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="detail.php?title=<?= $row["tieude"] ?>" class="text-decoration-none"><?= $row["tieude"] ?></a>
                        </h5>
                    </div>
                </div>
            </div>
